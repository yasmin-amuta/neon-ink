document.addEventListener("DOMContentLoaded", (event) => {
  ...
  var contentSection = gsap.timeline({
  ...
  contentSection
    ...
    .from(".sidebar h1", { opacity: 0, y: 50 })
    .from(".post-content", { x: 100, opacity: 0 });

  gsap.from(".pack-descr h1", {
    y: 50,
    opacity: 0,
    duration: 0.8,
    ease: "back",
    scrollTrigger: { trigger: ".package", start: "top 70%" },
  });
